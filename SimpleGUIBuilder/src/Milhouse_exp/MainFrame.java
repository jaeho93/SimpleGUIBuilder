...
public class MainFrame implements ActionListener{
   ...
   static JTextField xField = new JTextField(10);
   static JTextField yField = new JTextField(10);
   static JTextField wField = new JTextField(10);
   static JTextField hField = new JTextField(10);
